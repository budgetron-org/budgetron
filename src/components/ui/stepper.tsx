...
interface DefineStepperProps<Steps extends Stepperize.Step[]>
  ...
  StepperNavigation: (props: ComponentProps<'nav'>) => ReactElement
  StepperStep: (
  ...
  StepperTitle: (
    props: ComponentProps<'h4'> & { asChild?: boolean },
  ) => ReactElement
  StepperDescription: (
    props: ComponentProps<'p'> & { asChild?: boolean },
  ) => ReactElement
  StepperPanel: (
...
const StepperContext = createContext<StepperConfig | null>(null)
...
function defineStepper<const Steps extends Stepperize.Step[]>(
  ...steps: Steps
      ...
      return (
        <>
          <li
            ...
            <div
              className={cn(
                'stepper-step-content flex flex-col items-start',
...
function StepperDescription({
  ...
  return (
    <Comp
      className={cn(
        'stepper-step-description text-muted-foreground text-sm',
        className,
      )}
      {...props}>
      {children}
...
function useStepChildren(children: ReactNode) {
